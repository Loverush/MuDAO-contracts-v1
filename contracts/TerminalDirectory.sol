...
contract TerminalDirectory is ITerminalDirectory, Operatable {
	...
	/// @notice For each project ID, the DaoHub terminal that the direct payment addresses are proxies for.
    ...
    */
	...
	/** 
      @notice 
      Update the DaoHub terminal that payments to direct payment addresses will be forwarded for the specified project ID.
